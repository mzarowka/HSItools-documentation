...
dark~ref~: dark reference data;

white~ref~: white reference data.
...
t~int~white: integration time of white reference;

t~int~sample: integration time of captured data (sample).
